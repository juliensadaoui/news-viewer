...
namespace Insta.Project.LecteurRSS.SyndicationParser
{
    ...
    ///   à un flux RSS 0.91. Elle herite de la AbstractSyndicationParser
    ///   qui implemente de le pattern Template Method. Ce pattern permet
    ///   de decomposer l'analyser du fichier XML RSS 0.91 en plusieurs
    ///   étapes
    /// </summary>
    public class RSS_0_91_Parser : AbstractSyndicationParser
    {
        ...
        /// <summary>
        /// Instancie un nouveau analyseur de fichier XML pour les fichiers des flux
        ///     de syndication RSS 0.91
        /// </summary>
        /// <param name="document"></param>
        /// <param name="link"></param>
        /// <param name="format"></param>
        public RSS_0_91_Parser(XmlDocument document, Channel channel, String format) :
        ...
        #region -- Methode analysant le flux RSS 0.91 -- 

        /// <summary>
        /// Méthode qui analyse la balise "channel" d'un flux RSS 0.91.
        ...
        ///  analysé correspond à un flux RSS 0.91.
        /// </summary>
        ...
        /// <summary>
        /// Méthode qui analyse la balise "image" d'un flux RSS 0.91
        ...
        /// <summary>
        /// Méthode qui analyse les balises "item" d'un flux RSS 0.91.
        ...
        /// <summary>
        /// Les flux RSS 0.91 ne contiennent pas de balise "cloud"
        /// Ce type de flux n'est pas associé à un service web
        /// </summary>
